...
export function registerOverlay<A: Object, R>(Component: (props: { ...A, resolve: R => any, match: any }) => Element<any> ): (args: A) => Promise<R> {
...
export function OverlayContext({ match, children }: OverlayContextProps){
    ...
    return <Switch>
        ...
        <Route render={ () => Array.isArray(children) ? children[0] : children }/>
    </Switch>
}
