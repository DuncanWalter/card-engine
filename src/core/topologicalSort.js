...
export function topologicalSort<T, Id>(elements: Array<T & Elem<Id>>): Array<T & Elem<Id>> {

    const elementMap: Map<Id, ElemWrapper<Id>> = new Map(elements.map(e => [
        e.id, 
        {
            elem: e,
            header: {
    ...
    let next: ElemWrapper<Id> | null, retVal: Array<Elem<Id>> = [];
