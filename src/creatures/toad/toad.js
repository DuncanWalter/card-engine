...
const ribbit: BehaviorState = defineBehavior('Toad Ribbit', function*({ owner, resolver, game }){
...
const lick: BehaviorState = defineBehavior('Toad Lick', function*({ owner, resolver, game }){
...
const bite: BehaviorState = defineBehavior('Toad Bite', function*({ owner, resolver, game }){
