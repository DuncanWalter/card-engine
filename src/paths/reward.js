...
type Init<D> = (self: Reward<D>, game:Game, seed: Sequence<number>) => Reward<D>
type CollectInternal<D> = (self: Reward<D>, resolver: EventResolver, game: Game) => Generator<Promise<any>, void, any>
...
const rewardLibrary: Map<string, RewardDefinition<any>> = new Map()
function any(any: any): any { return any }

// TODO: reflect generator crap. yay.
export function registerReward<D:Object>(type: string, description: string, cost: number, collect: CollectInternal<D>, init?: Init<D>){
...
export function getRewards(rewardFunds: number, game: Game, seed: Sequence<number>): Reward<any>[] {
