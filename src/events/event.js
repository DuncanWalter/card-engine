...
export const startTurn: ListenerType<{ subject: Creature<>, data: any }> = any(
  'startTurn'
)
export const startCombat: ListenerType<{
  subject: Creature<>,
  data: any,
}> = any('startCombat')
export const endTurn: ListenerType<{ subject: Creature<>, data: any }> = any(
  'endTurn'
)
