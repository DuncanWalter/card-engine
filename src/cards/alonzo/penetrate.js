...
export const Penetrate: () => Card<PenetrateData> = defineCard('penetrate', playPenetrate, {
    damage: 7,
    energy: 1,
    strength: 1,
}, {
...
function* playPenetrate(self: Card<PenetrateData>, { resolver, actors, energy, game }: PlayArgs): Generator<any, PenetrateData, any> {
    ...
    const binding: BindEffect = yield resolver.processEvent(new BindEffect(self, game.player, {
        Effect: Strength,
