...
export const Crack: () => Card<CrackData> = defineCard(crack, playCrack, {
    energy: 0,
    damage: 4,
}, {
    ...
    color: '#ee4422',
    title: 'Crack',
    text: 'Deal #{damage} damage. All cards with #[Cache] deal 1 additional damage per stack of #[Cache]. #[Cache].',
}, [Cache, 1])
