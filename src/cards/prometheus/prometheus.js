...
let prometheus = new Character('Prometheus', true, '#2b990a', 'A recently discovered entity emergent from the complexity of the global network. Capable of completing complicated tasks using computing primitives in novel ways, and therefore a subject of much study. Unsettlingly, also seems capable of some agency.')
